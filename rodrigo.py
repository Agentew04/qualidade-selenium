...
def test_giving_button():
    ...
    sleep(1)
    giving_button = firefox_driver.find_element(
        By.XPATH, '//*[@id="page"]/header/div[1]/div[2]/nav/ul/li[5]/a'
    )
    ...
    giving_button.click()
    assert (
        firefox_driver.current_url
        == "https://www.ut.edu/development-and-university-relations"
    )
    sleep(1)

    sleep(10)
    give_now_button = firefox_driver.find_element(
        By.XPATH, '//*[@id="content"]/div/div/div[2]/div/div/ul/li[2]/a'
    )
    ...
    assert (
        firefox_driver.current_url
        == "https://www.ut.edu/development-and-university-relations/give-now"
    )
...
def testa_formulario_doacao():
    ...
    sleep(10)
    fifty_dollars_donation_button = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_gift_rdlstGiving' 'Levels"]/div[2]/div/label'
    )
    # fifty_dollars_donation_input = chrome_driver.find_element(By.XPATH, '//*[@id="bboxdonation_gift_rdGiving'
    #                                                                     'Level2"]')
    hundred_dollars_donation_button = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_gift_rdlstGiving' 'Levels"]/div[4]/div/label'
    )
    ...
    assert (
        hundred_dollars_donation_button.get_attribute("class")
        == "BBFormRadioLabel BBFormRadioLabelGivingLevel BBFormRadioLabelGivingLevelSelected"
    )
    assert (
        fifty_dollars_donation_button.get_attribute("class")
    ...
    primeiro_nome_textbox = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_billing_txtFirstName"]'
    )
    ...
    segundo_nome_textbox = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_billing_txtLastName"]'
    )
    ...
    email_textbox = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_billing_txtEmail"]'
    )
    ...
    country_combobox = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_billing_billingAddress_ddCountry"]'
    )
    ...
    endereco_textbox = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_billing_billingAddress_txtAddress"]'
    )
    ...
    submit = chrome_driver.find_element(
        By.XPATH, '//*[@id="bboxdonation_btnSecurePayment"]'
    )
    assert submit is not None
    assert submit.is_displayed()

    ActionChains(chrome_driver).move_to_element(submit).perform()
    assert submit.value_of_css_property("background-color") == "rgba(0, 178, 0)"
    assert submit.value_of_css_property("border") == "0 solid rgba(0, 178, 0)"
    sleep(1)
    chrome_driver.quit()
...
def test_expander_admissions():
    ...
    admissions = firefox_driver.find_element(
        By.XPATH, '//*[@id="page"]/header/div[1]/div[3]/nav/ul/li[1]/a'
    )
    ...
    assert (
        firefox_driver.current_url
        == "https://www.ut.edu/admissions/spartan-ambassadors"
    )
    firefox_driver.quit()
...
def test_expander_academics():
    ...
    academics = firefox_driver.find_element(
        By.XPATH, '//*[@id="page"]/header/div[1]/div[3]/nav/ul/li[3]/a'
    )
